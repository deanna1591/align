...
// The single Calendar scope we request. Read+write events on any
// calendar the user owns. Narrower than full `auth/calendar`, which
// keeps the consent screen friendlier and verification easier.
export const CALENDAR_WRITE_SCOPE =
  'https://www.googleapis.com/auth/calendar.events';

const SCOPES = ['openid', 'email', CALENDAR_WRITE_SCOPE];

// Helper for the UI: does this connection have write permission?
// Existing connections (granted under the v1 read-only scopes) will
// return false until the user reconnects.
